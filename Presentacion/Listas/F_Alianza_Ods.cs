...
{
    public partial class F_Alianza_Ods : Frm_Lista_Base
    {
        public F_Alianza_Ods(int idusuario, int idRol, string usuario)
        {
            InitializeComponent();
        ...
        private void F_Alianza_Ods_Load(object sender, EventArgs e)
        {
            IODS = new Ods();
        ...
        private void F_Alianza_Ods_Evento_Actualizar_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    ...
                    mAlianza_Ods frm = new mAlianza_Ods();
                    frm.Modo = "M";
                    frm.Id_Contacto_Ods = Convert.ToInt32(this.lstDatos.SelectedItems[0].Text);//.ToString
                    frm.MostrarIngresar = false;
                    frm.MostrarEliminar = false;
                    frm.MostrarConsultar = false;
                    frm.Controls["Txt_Id_Contacto_Ods"].Enabled = false;
                    frm.ShowDialog();
                    F_Alianza_Ods_Load(null, null);
                }
        ...
        private void F_Alianza_Ods_Evento_Consultar(object sender, EventArgs e)
        {
            try
            {
                SqlConnection _Conexion = new SqlConnection(@"Data Source=DESKTOP-C5D2V8H; Initial Catalog= CITRA; Integrated Security= true");
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    BAlianza_Ods frm = new BAlianza_Ods();
                    frm.ShowDialog();
                }
                else { MessageBox.Show("El usuario no tiene permisos para realizar esta acción", "Validación de Datos", MessageBoxButtons.OK, MessageBoxIcon.Error); ; return; }
            }
        ...
        private void F_Alianza_Ods_Evento_Eliminar(object sender, EventArgs e)
        {
            try
            {
                SqlConnection _Conexion = new SqlConnection(@"Data Source=DESKTOP-C5D2V8H; Initial Catalog= CITRA; Integrated Security= true");
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    ...
                    mAlianza_Ods frm = new mAlianza_Ods();
                    frm.Modo = "E";
                    frm.Id_Contacto_Ods = Convert.ToInt32(this.lstDatos.SelectedItems[0].Text);
                    frm.MostrarIngresar = false;
                    frm.MostrarConsultar = false;
                    frm.MostrarActualizar = false;
                    frm.Controls["Txt_Id_Contacto_Ods"].Enabled = false;
                    frm.Controls["Cbo_Nombre_Organizacion"].Enabled = false;
                    frm.Controls["Txt_Nombre_Contacto"].Enabled = false;
                    frm.Controls["Cbo_Nombre_Cargo"].Enabled = false;
                    frm.Controls["Txt_Correo_Ods"].Enabled = false;
                    frm.Controls["Txt_Telefono"].Enabled = false;
                    frm.Controls["Txt_Telefono2"].Enabled = false;
                    frm.Controls["Cbo_Nombre_Sector"].Enabled = false;
                    frm.ShowDialog();
                    F_Alianza_Ods_Load(null, null);
                }
                else { MessageBox.Show("El usuario no tiene permisos para realizar esta acción", "Validación de Datos", MessageBoxButtons.OK, MessageBoxIcon.Error); ; return; }
        ...
        private void F_Alianza_Ods_Evento_Ingresar(object sender, EventArgs e)
        {
            try
            {
                SqlConnection _Conexion = new SqlConnection(@"Data Source=DESKTOP-C5D2V8H; Initial Catalog= CITRA; Integrated Security= true");
        ...
        private void F_Alianza_Ods_Evento_Salir(object sender, EventArgs e)
        {
            this.Close();
        }
