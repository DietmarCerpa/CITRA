...
{
    public partial class F_Sectores : Frm_Lista_Base
    {
        public F_Sectores(int idusuario, int idRol, string usuario)
        {
            InitializeComponent();
        ...
        Sectores ISECTORES;
        private void F_Sectores_Load(object sender, EventArgs e)
        {
        ...
        private void F_Sectores_Evento_Actualizar_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    ...
                    mSectores frm = new mSectores();
                    frm.Modo = "M";
                    frm.Id_Sector = Convert.ToInt32(this.lstDatos.SelectedItems[0].Text);//.ToString
        ...
        private void F_Sectores_Evento_Consultar(object sender, EventArgs e)
        {
            try
            {
                SqlConnection _Conexion = new SqlConnection(@"Data Source=DESKTOP-C5D2V8H; Initial Catalog= CITRA; Integrated Security= true");
        ...
        private void F_Sectores_Evento_Eliminar(object sender, EventArgs e)
        {
            try
            {
                SqlConnection _Conexion = new SqlConnection(@"Data Source=DESKTOP-C5D2V8H; Initial Catalog= CITRA; Integrated Security= true");
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    ...
                    mSectores frm = new mSectores();
                    frm.Modo = "E";
                    frm.Id_Sector = Convert.ToInt32(this.lstDatos.SelectedItems[0].Text);
                    frm.MostrarIngresar = false;
                    frm.MostrarConsultar = false;
        ...
        private void F_Sectores_Evento_Ingresar(object sender, EventArgs e)
        {
            try
            {
                SqlConnection _Conexion = new SqlConnection(@"Data Source=DESKTOP-C5D2V8H; Initial Catalog= CITRA; Integrated Security= true");
        ...
        private void F_Sectores_Evento_Salir(object sender, EventArgs e)
        {
            this.Close();
        }
    }
