...
{
    public partial class F_Camaras_Privadas : Frm_Lista_Base
    {

        SqlConnection _Conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["MiConexion"].ToString());

        public F_Camaras_Privadas(int idusuario, int idRol, string usuario)
        {
            InitializeComponent();
        ...
        private void F_Camaras_Privadas_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                dt = ICamaras_Privadas.LlenarLista();
        ...
        private void F_Camaras_Privadas_Evento_Actualizar_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    ...
                    mCamaras_Privadas frm = new mCamaras_Privadas();
                    frm.Modo = "M";
                    frm.Id_Contacto_Camara = Convert.ToInt32(this.lstDatos.SelectedItems[0].Text);//.ToString
                    frm.MostrarIngresar = false;
                    frm.MostrarEliminar = false;
                    frm.MostrarConsultar = false;
                    frm.Controls["Txt_Id_Contacto_Camara"].Enabled = false;
                    frm.Controls["Txt_Nombre_Contacto_Camara"].Enabled = false;
                    frm.ShowDialog();
                    F_Camaras_Privadas_Load(null, null);
                }
        ...
        private void F_Camaras_Privadas_Evento_Consultar(object sender, EventArgs e)
        {
            try
            {
                string CadenaSql = "SELECT  [CITRA].[dbo].Usuarios.Id_Usuario from [CITRA].[dbo].Permisos_x_Rol " +
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    BCamaras_Privadas frm = new BCamaras_Privadas();
                    frm.ShowDialog();
                }
                else { MessageBox.Show("El usuario no tiene permisos para realizar esta acción", "Validación de Datos", MessageBoxButtons.OK, MessageBoxIcon.Error); ; return; }
        ...
        private void F_Camaras_Privadas_Evento_Eliminar(object sender, EventArgs e)
        {
            try
            {
                string CadenaSql = "SELECT  [CITRA].[dbo].Usuarios.Id_Usuario from [CITRA].[dbo].Permisos_x_Rol " +
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    ...
                    mCamaras_Privadas frm = new mCamaras_Privadas();
                    frm.Modo = "E";
                    frm.Id_Contacto_Camara = Convert.ToInt32(this.lstDatos.SelectedItems[0].Text);
                    frm.MostrarIngresar = false;
                    frm.MostrarConsultar = false;
                    ...
                    frm.Controls["Txt_Nombre_Contacto_Camara"].Enabled = false;
                    frm.Controls["Txt_Correo_Camara"].Enabled = false;
                    frm.Controls["Txt_Telefono"].Enabled = false;
        ...
        private void F_Camaras_Privadas_Evento_Ingresar(object sender, EventArgs e)
        {
            try
            {           
                string CadenaSql = "SELECT  [CITRA].[dbo].Usuarios.Id_Usuario from [CITRA].[dbo].Permisos_x_Rol " +
        ...
        private void F_Camaras_Privadas_Evento_Salir(object sender, EventArgs e)
        {
            this.Close();
        }
