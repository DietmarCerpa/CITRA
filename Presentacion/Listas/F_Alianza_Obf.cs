...
{
    public partial class F_Alianza_Obf : Frm_Lista_Base
    {
        public F_Alianza_Obf(int idusuario, int idRol, string usuario)
        {
            InitializeComponent();
        ...
        private void F_Alianza_Obf_Load(object sender, EventArgs e)
        {
            IOBF = new Obf();
        ...
        private void F_Alianza_Obf_Evento_Actualizar_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    ...
                    mAlianza_Obf frm = new mAlianza_Obf();
                    frm.Modo = "M";
                    frm.Id_Contacto_Obf = Convert.ToInt32(this.lstDatos.SelectedItems[0].Text);//.ToString
                    frm.MostrarIngresar = false;
                    frm.MostrarEliminar = false;
                    frm.MostrarConsultar = false;
                    frm.Controls["Txt_Id_Contacto_Obf"].Enabled = false;
                    frm.ShowDialog();
                    F_Alianza_Obf_Load(null, null);
                }
        ...
        private void F_Alianza_Obf_Evento_Consultar(object sender, EventArgs e)
        {
            try
            {
                SqlConnection _Conexion = new SqlConnection(@"Data Source=DESKTOP-C5D2V8H; Initial Catalog= CITRA; Integrated Security= true");
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    BAlianza_Obf frm = new BAlianza_Obf();
                    frm.ShowDialog();
                }
                else { MessageBox.Show("El usuario no tiene permisos para realizar esta acción", "Validación de Datos", MessageBoxButtons.OK, MessageBoxIcon.Error); ; return; }
            }
        ...
        private void F_Alianza_Obf_Evento_Eliminar(object sender, EventArgs e)
        {
            try
            {
                SqlConnection _Conexion = new SqlConnection(@"Data Source=DESKTOP-C5D2V8H; Initial Catalog= CITRA; Integrated Security= true");
                ...
                if (resultado > 0) /*Si tiene persmisos haga esto*/
                {
                    ...
                    mAlianza_Obf frm = new mAlianza_Obf();
                    frm.Modo = "E";
                    frm.Id_Contacto_Obf = Convert.ToInt32(this.lstDatos.SelectedItems[0].Text);
                    frm.MostrarIngresar = false;
                    frm.MostrarConsultar = false;
                    ...
                    frm.Controls["Txt_Correo_Obf"].Enabled = false;
                    frm.Controls["Txt_Telefono_Obf"].Enabled = false;
        ...
        private void F_Alianza_Obf_Evento_Ingresar(object sender, EventArgs e)
        {
            try
            {
                SqlConnection _Conexion = new SqlConnection(@"Data Source=DESKTOP-C5D2V8H; Initial Catalog= CITRA; Integrated Security= true");
        ...
        private void F_Alianza_Obf_Evento_Salir(object sender, EventArgs e)
        {
            this.Close();
        }
    }
